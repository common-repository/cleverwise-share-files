...
EOM;
	...
	////////////////////////////////////////////////////////////////////////////
		...
		$cw_share_files_whats_new=array(
			'2.4'=>'Fixed: Deprecated function warning|Theme changes',
			'2.2'=>'Minor theme changes',
			'2.1'=>'Fixed for https links',
			'2.0'=>'Altered File Sections to allow for hyphens|Altered Root URL to allow tilde using %7e standard',
			'1.9'=>'Fixed: An invalid warning notice',
			'1.8'=>'Background edits to eliminate some PHP notice messages',
			'1.7'=>'Fixed: Editor permission bug',
			'1.6'=>'Fixed: Shortcode in certain areas would cause incorrect placement',
			'1.5'=>'Fixed: Support and rating links',
			'1.4'=>'UI changes',
			'1.3'=>'Fixed: Anti-bot word/phrase bug causing errors',
			'1.2'=>'Altered framework code to fit Wordpress Plugin Directory terms',
			'1.1'=>'Modified to use the Cleverwise Framework|Fixed: Incorrect download code error screen failed when another form was displayed',
			'1.0'=>'Initial release of plugin'
		);
		$cw_share_files_whats_new_build='';
		foreach ($cw_share_files_whats_new as $cw_share_files_whats_new_version => $cw_share_files_whats_new_news) {
			$cw_share_files_whats_new_build .='<p>Version: <b>'.$cw_share_files_whats_new_version.'</b></p>';
			$cw_share_files_whats_new_news=preg_replace('/\|/','</li><li>',$cw_share_files_whats_new_news);
			$cw_share_files_whats_new_build .='<ul style="list-style: disc; margin-left: 25px;"><li>'.$cw_share_files_whats_new_news.'</li></ul>';
		}
...
$cw_share_files_html .=<<<EOM
<div style="margin-top: 30px; border-top: 1px dotted #d6d6cf; padding-top: 5px;">Admin Functions:<br><a href="?page=cw-share-files&cw_action=settings">Settings</a> | <a href="?page=cw-share-files&cw_action=settingshelp">Help Guide</a> | <a href="?page=cw-share-files&cw_action=settingsnew">What Is New?</a> | <a href="?page=cw-share-files&cw_action=settingsfuture">Future Ideas</a></p></div>
EOM;
	}
	}
...
$cw_plugin_hname='Cleverwise Share Files';
print <<<EOM
<style type="text/css">
...
<div id="cws-nav" name="cws-nav">&#10058; <a href="?page=cw-share-files">Main Panel</a> &#10058; <a href="?page=cw-share-files&cw_action=files">File Management</a> &#10058; <a href="?page=cw-share-files&cw_action=cats">Category Management</a></div>
